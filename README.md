...
Packages = https://github.com/tbhb/vale-ai-tells/releases/download/v1.11.0/ai-tells.zip, \
  https://github.com/tbhb/vale-ai-tells/releases/download/v1.9.0/ai-tells-commits.zip
