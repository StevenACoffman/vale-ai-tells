...
Packages = https://github.com/tbhb/vale-ai-tells/releases/download/v1.15.0/ai-tells.zip, \
  https://github.com/tbhb/vale-ai-tells/releases/download/v1.15.0/ai-tells-commits.zip
...
This package contains 50 rule files covering different categories of AI tells. All rules default to `error` level.
